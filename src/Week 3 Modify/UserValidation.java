public class UserValidation {
    ...
    public static String validateStorageInstructions(String instructions) {
        ...
        try {
            Double.valueOf(instructions);
            throw new IllegalArgumentException("Storage Instructions cannot be a number. Please enter a valid value.");
    ...
    public static String validateColor(String color) {
        if (color.trim().isEmpty()) {
            throw new IllegalArgumentException("Color cannot be empty. Please enter a valid value.");
        }
        try {
            Double.valueOf(color);
            throw new IllegalArgumentException("Color cannot be a number. Please enter a valid value.");
        } catch (NumberFormatException e) {
            return color.trim();
        }
    }
